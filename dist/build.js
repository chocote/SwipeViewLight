...
(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define('cdimage', factory);
    } else if (typeof module === 'object' && module.exports) {
        module.exports = factory(root.document);
    } else {
        root.CDImage = factory(root.document);
    }
}(window, function(doc) {
    ...
    var CDImage = {
        ...
        load: function(src, callback, crossOrigin) {
            ...
            idoc.domain = window.location.host;
            idoc.open();
...
},{"./cdimage":2,"./events":3,"jquery":1}],5:[function(require,module,exports){
...
},{"./mediagallery":6,"jquery":1}],6:[function(require,module,exports){
var $ = require('jquery');
var Events =  require('./events');
...
},{"./events":3,"./galleryimageview":4,"./swipeviewlight":7,"jquery":1}],7:[function(require,module,exports){
/*
 *  SwipeViewLight.js
...
var SwipeViewLight = (function(window, document) {
    ...
    _extend(SwipeViewLight.prototype, Events, {
        ...
        goTo: function(index) {
            if (!isNaN(index))
                ...
                throw 'SwipeViewLight: Error, @index param no valid';
        },
        prev: function() {
        ...
        doSlide: function(index, speed) {
            ...
            if (speed > 0 && hasTransform && hasTransitionEnd) {
                ...
                addEvt(newView.el, TRNEND_EV, function _transitionEnd() {
                    rmEvt(this, TRNEND_EV, _transitionEnd, false);
                    that.slideEnd();
                }, false);
